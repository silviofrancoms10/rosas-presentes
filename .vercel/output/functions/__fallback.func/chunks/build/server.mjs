...
const unhead_rbdoe1vkBwNPqu1fbX2lqdSE0Yc5KxVTf5NlHv8kk_U = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-DYKTyKDp.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-CLvjARrt.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BVk7_VPX.mjs')
  }
];
...
const revive_payload_server_lNMR_zkYILengpwEO4WZSn1TJkhFLv87mEfT5kmTLd0 = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead_rbdoe1vkBwNPqu1fbX2lqdSE0Yc5KxVTf5NlHv8kk_U,
  plugin$1,
  revive_payload_server_lNMR_zkYILengpwEO4WZSn1TJkhFLv87mEfT5kmTLd0,
  plugin,
...
const useCartStore = defineStore("cart", () => {
  ...
  function updateQuantity(productId, quantity) {
    ...
    const item = items.value.find((item2) => item2.product.id === productId);
    if (item) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ge-SX-HO.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B98uk6fN.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.8_@babel+plugin-proposal-decorators@7.29.7_@babel+core@7.29.7__@babel+plugin-s_f94ab86709d6e3928d3b183175bb516e/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.8_@babel+plugin-proposal-decorators@7.29.7_@babel+core@7.29.7__@babel+plugin-s_f94ab86709d6e3928d3b183175bb516e/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useCartStore as d, entry_default as default, encodeRoutePath as e, useRoute as f, useFetch as g, navigateTo as n, resolveRouteObject as r, useRouter as u };
