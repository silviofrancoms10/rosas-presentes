...
import { u as useRouter, f as useRoute, d as useCartStore } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><button class="${ssrRenderClass([unref(route).path === "/checkout" ? "text-white border-white" : "text-almond/75 border-transparent", "hover:text-white transition-colors cursor-pointer pb-1 border-b-2"])}"> 💳 Checkout </button></nav><button class="relative p-2.5 hover:bg-white/10 rounded-xl transition-all"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>`);
...
//# sourceMappingURL=Footer-OHQ6d5J-.mjs.map
