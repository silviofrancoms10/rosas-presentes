...
<template>
  <div class="min-h-screen flex flex-col">
    ...
    <main class="max-w-4xl mx-auto px-4 pt-8 flex-grow">
      ...
      <div v-if="isSubmitted" class="form-card text-center py-12 space-y-6 max-w-xl mx-auto my-8">
        ...
        <div class="space-y-2">
          ...
          <div class="inline-block bg-white/60 border border-burgundy/10 px-4 py-2 rounded-xl mt-2 font-mono text-sm font-bold text-burgundy">
    ...
    <div class="mobile-navigation-bar">
      ...
      <button class="mobile-nav-item mobile-nav-item-active" @click="router.push('/checkout')">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5.5 w-5.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        ...
        <span class="text-[10px] mt-0.5 font-semibold">Ajuda</span>
      </a>
    </div>
